...
public class Bayraklar {
    ...
    public Bayraklar(int bayrak_id, String bayrak_ad, String getBayrak_resim) {
        this.bayrak_id = bayrak_id;
        this.bayrak_ad = bayrak_ad;
        this.bayrak_resim = getBayrak_resim;
    }
    ...
    public void setBayrak_resim(String getBayrak_resim) {
        this.bayrak_resim = getBayrak_resim;
    }
}
